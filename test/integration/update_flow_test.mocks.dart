...
// in expense_tracker/test/integration/update_flow_test.dart.
...
class MockAppLifecycleService extends _i1.Mock
    implements _i7.AppLifecycleService {
  MockAppLifecycleService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  void startObserving({required _i8.VoidCallback? onResume}) =>
      super.noSuchMethod(
        Invocation.method(#startObserving, [], {#onResume: onResume}),
        returnValueForMissingStub: null,
      );
