...
- [x] T011 [P] [US1] Unit test for Trip model validation in test/features/trips/domain/models/trip_test.dart (test allowedCurrencies validation: minimum 1 currency, maximum 10 currencies, no duplicates, valid currency codes)
- [x] T012 [P] [US1] Unit test for TripModel serialization in test/features/trips/data/models/trip_model_test.dart (test fromFirestore with allowedCurrencies, test fromFirestore with legacy baseCurrency, test toFirestore, test toDomain migration logic)
